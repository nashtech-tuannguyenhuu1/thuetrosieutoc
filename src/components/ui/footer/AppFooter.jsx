    ...
    <footer>
       <Row className='footer'>
        <Col xs={12} md={8}>
          ...
          <i className="pi pi-phone"> 0986040618</i><br></br>
          <i className="pi pi-map-marker"> 19 Nguyen Cong Trum An Hai Tay, Son Tra, Da Nang</i><br></br>
          <i className="pi pi-envelope"> gamatgiunsan@gmail.com</i>
        </Col>
        {/* <Col xs={12} md={4}>
